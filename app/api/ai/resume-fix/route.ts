  ...
  try {
    ...
    const completion = await groq.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an expert resume editor. Apply the requested improvements thoroughly. Each improvement must be fully addressed — not superficially touched. Never fabricate experience, companies, dates, titles, or metrics. Never add commentary or preamble to your output.",
        },
        {
          role: "user",
